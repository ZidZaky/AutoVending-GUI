// FILE: UnitTest/AddProductTest.cs
...
namespace UnitTest
{
    ...
    public class AddProductTest
    {
        ...
        [TestMethod]
        public void Constructor_SaatFormDibuat_HarusMemuatProdukDariService()
        {
        ...
        [TestMethod]
        public void AddNewProduct_SaatTombolAddDitekan_HarusMenambahItemBaruKeList()
        {
        ...
        [TestMethod]
        public void SaveAllData_SaatTombolSaveDitekan_HarusMemanggilSaveProducts()
        {
            addProductForm.buttonAddNewProduct_Click(null, EventArgs.Empty);
